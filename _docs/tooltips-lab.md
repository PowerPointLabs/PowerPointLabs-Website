...
**Create Tooltip** allows you to create a complete tooltip from scratch.

To add a new tooltip to a slide, go to `Tooltips Lab` and select `Create Tooltip`.
...
**Create Callout for Shape** allows you to create a callout for your provided shape. Your provided shape will be the trigger for the callout generated for you by Tooltips Lab.
